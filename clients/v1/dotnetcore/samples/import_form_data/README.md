# Sample - Import data into PDF forms using C# in .Net Core

The C# sample provided in this section uses the [*Muhimbi PDF Converter Services Online*](https://github.com/Muhimbi/PDF-Converter-Services-Online) to import data (.fdf, .xfdf and .xml) into PDF forms.
