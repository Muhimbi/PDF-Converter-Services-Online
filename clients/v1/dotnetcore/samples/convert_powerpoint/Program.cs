        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                if (args.Count() == 0)
                {
                    ...
                    testFile = Directory.GetFiles(".", "*.pptx")[0];
                }
                else
                    testFile = args[0];
                ...
                ConvertPowerpointData inputData = new ConvertPowerpointData(
                    ...
                    outputFormat: ConvertPowerpointData.OutputFormatEnum.PDF, // ** The format to convert the file to (not all combinations are supported)
                ...
                var response = convertAPI.ConvertPowerpoint(inputData);
