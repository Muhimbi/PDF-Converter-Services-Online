        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                EllipseWatermarkData inputData = new EllipseWatermarkData(
                    ...
                    lineWidth: "10",                                                // ** The width of the line in pts (1/72nd of an inch). 0 = hairline, -1 = no line                    StartPage: 0,                                                   // ** The first page in the document the watermark applies to.
                    ...
                    printOnly: EllipseWatermarkData.PrintOnlyEnum.False             // ** If set to true then watermarks only appear during print
                    );
