        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                if (args.Count() == 0)
                {
                    ...
                    testFile = Directory.GetFiles(".", "*.dwg")[0];
                }
                else
                    testFile = args[0];
                ...
                ConvertCadData inputData = new ConvertCadData(
                    ...
                    foregroundColor: ConvertCadData.ForegroundColorEnum.GreyscaleDarken, //** Make foreground grayscale and darken a bit for better visibility
                ...
                var response = convertAPI.ConvertCad(inputData);
