        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                if (args.Count() == 0)
                {
                    ...
                    testFile = Directory.GetFiles(".", "*.vsd")[0];
                }
                else
                    testFile = args[0];
                ...
                ConvertVisioData inputData = new ConvertVisioData(
                    ...
                    outputFormat: ConvertVisioData.OutputFormatEnum.PDF,    // ** The format to convert the file to (not all combinations are supported)
                ...
                var response = convertAPI.ConvertVisio(inputData);
