# Sample - Convert files to various PDF profiles using C# in .Net Core

The C# sample provided in this section uses the [*Muhimbi PDF Converter Services Online*](https://github.com/Muhimbi/PDF-Converter-Services-Online) to convert documents to various PDF profiles (for example PDF/A-2b).
