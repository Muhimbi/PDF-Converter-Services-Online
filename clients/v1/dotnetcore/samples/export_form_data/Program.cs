        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                ExportFormData inputData = new ExportFormData(
                    ...
                    outputFormat: ExportFormData.OutputFormatEnum.XFDF  // ** The format to convert the file to (not all combinations are supported)
                    );

                // ** Carry out the conversion
                Console.WriteLine("[INFO] Converting...");
                var response = convertAPI.ExportFormData(inputData);
