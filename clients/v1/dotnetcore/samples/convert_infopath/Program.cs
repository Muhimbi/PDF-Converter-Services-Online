        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                if (args.Count() == 0)
                {
                    ...
                    testFile = Directory.GetFiles(".", "*.xml")[0];
                }
                else
                    testFile = args[0];
                ...
                if (args.Count() < 2)
                {
                    ...
                    templateFile = Directory.GetFiles(".", "*.xsn")[0];
                }
                else
                    templateFile = args[1];
                ...
                ConvertInfopathData inputData = new ConvertInfopathData(
                    ...
                    templateFileContent: templateFileContent,               // ** Optionally, set the XSN template file as well
                    outputFormat: ConvertInfopathData.OutputFormatEnum.PDF, // ** The format to convert the file to (not all combinations are supported)
                ...
                var response = convertAPI.ConvertInfopath(inputData);
