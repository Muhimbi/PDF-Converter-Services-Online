        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                ConvertExcelData inputData = new ConvertExcelData(
                    ...
                    outputFormat: ConvertExcelData.OutputFormatEnum.PDF, // ** The format to convert the file to (not all combinations are supported)
                ...
                var response = convertAPI.ConvertExcel(inputData);
