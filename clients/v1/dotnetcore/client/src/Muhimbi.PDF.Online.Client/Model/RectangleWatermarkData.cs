...
namespace Muhimbi.PDF.Online.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "rectangle_watermark_data")]
    public partial class RectangleWatermarkData : IEquatable<RectangleWatermarkData>, IValidatableObject
    {
        ...
        public RectangleWatermarkData(string sourceFileName = default(string), bool useAsyncPattern = false, byte[] sourceFileContent = default(byte[]), PositionEnum position = PositionEnum.MiddleCenter, SharepointFile sharepointFile = default(SharepointFile), string width = default(string), string height = default(string), string x = default(string), string y = default(string), LayerEnum? layer = LayerEnum.Foreground, string rotation = default(string), string opacity = "100", string fillColor = default(string), string lineColor = default(string), string lineWidth = default(string), int startPage = default(int), int endPage = default(int), int pageInterval = default(int), PageOrientationEnum? pageOrientation = PageOrientationEnum.Both, PrintOnlyEnum? printOnly = PrintOnlyEnum.False, int startSection = default(int), int endSection = default(int), string pageType = default(string), bool failOnError = true)
        {
            ...
            {
                throw new ArgumentNullException("sourceFileContent is a required property for RectangleWatermarkData and cannot be null");
            }
            ...
            if (width == null)
            {
                throw new ArgumentNullException("width is a required property for RectangleWatermarkData and cannot be null");
            }
            this.Width = width;
            // to ensure "height" is required (not null)
            if (height == null)
            {
                throw new ArgumentNullException("height is a required property for RectangleWatermarkData and cannot be null");
            }
            this.Height = height;
        ...
        {
            return this.Equals(input as RectangleWatermarkData);
        }

        /// <summary>
        /// Returns true if RectangleWatermarkData instances are equal
        /// </summary>
        /// <param name="input">Instance of RectangleWatermarkData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RectangleWatermarkData input)
        {
            if (input == null)
            {
                return false;
