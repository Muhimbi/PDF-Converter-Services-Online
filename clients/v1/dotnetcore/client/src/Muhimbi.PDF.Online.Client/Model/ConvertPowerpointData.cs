...
namespace Muhimbi.PDF.Online.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "convert_powerpoint_data")]
    public partial class ConvertPowerpointData : IEquatable<ConvertPowerpointData>, IValidatableObject
    {
        ...
        {
            /// <summary>
            /// Enum Slides for value: Slides
            /// </summary>
            [EnumMember(Value = "Slides")]
            Slides = 1,

            /// <summary>
            /// Enum OneSlideHandouts for value: OneSlideHandouts
            /// </summary>
            [EnumMember(Value = "OneSlideHandouts")]
            OneSlideHandouts = 2,

            /// <summary>
            /// Enum TwoSlideHandouts for value: TwoSlideHandouts
            /// </summary>
            [EnumMember(Value = "TwoSlideHandouts")]
            TwoSlideHandouts = 3,

            /// <summary>
            /// Enum ThreeSlideHandouts for value: ThreeSlideHandouts
            /// </summary>
            [EnumMember(Value = "ThreeSlideHandouts")]
            ThreeSlideHandouts = 4,

            /// <summary>
            /// Enum FourSlideHandouts for value: FourSlideHandouts
            /// </summary>
            [EnumMember(Value = "FourSlideHandouts")]
            FourSlideHandouts = 5,

            /// <summary>
            /// Enum SixSlideHandouts for value: SixSlideHandouts
            /// </summary>
            [EnumMember(Value = "SixSlideHandouts")]
            SixSlideHandouts = 6,

            /// <summary>
            /// Enum NineSlideHandouts for value: NineSlideHandouts
            /// </summary>
            [EnumMember(Value = "NineSlideHandouts")]
            NineSlideHandouts = 7,

            /// <summary>
            /// Enum NotesPages for value: NotesPages
            /// </summary>
        ...
        public ConvertPowerpointData(bool useAsyncPattern = false, string sourceFileName = default(string), SharepointFile sharepointFile = default(SharepointFile), byte[] sourceFileContent = default(byte[]), OutputFormatEnum outputFormat = OutputFormatEnum.PDF, bool copyMetadata = false, RangeEnum? range = default(RangeEnum?), PrintOutputTypeEnum? printOutputType = PrintOutputTypeEnum.Slides, bool frameSlides = true, int startPage = default(int), int endPage = default(int), QualityEnum? quality = default(QualityEnum?), string overrideSettings = default(string), bool failOnError = true)
        {
            ...
            {
                throw new ArgumentNullException("sourceFileName is a required property for ConvertPowerpointData and cannot be null");
            }
            this.SourceFileName = sourceFileName;
            // to ensure "sourceFileContent" is required (not null)
            if (sourceFileContent == null)
            {
                throw new ArgumentNullException("sourceFileContent is a required property for ConvertPowerpointData and cannot be null");
            }
        ...
        [DataMember(Name = "frame_slides", EmitDefaultValue = true)]
        ...
        {
            return this.Equals(input as ConvertPowerpointData);
        }

        /// <summary>
        /// Returns true if ConvertPowerpointData instances are equal
        /// </summary>
        /// <param name="input">Instance of ConvertPowerpointData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConvertPowerpointData input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.PrintOutputType == input.PrintOutputType ||
                    this.PrintOutputType.Equals(input.PrintOutputType)
                ) && 
                (
                    this.FrameSlides == input.FrameSlides ||
                    this.FrameSlides.Equals(input.FrameSlides)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.PrintOutputType.GetHashCode();
                hashCode = (hashCode * 59) + this.FrameSlides.GetHashCode();
