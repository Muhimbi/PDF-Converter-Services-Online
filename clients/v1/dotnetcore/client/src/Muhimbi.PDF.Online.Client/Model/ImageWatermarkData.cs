...
namespace Muhimbi.PDF.Online.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "image_watermark_data")]
    public partial class ImageWatermarkData : IEquatable<ImageWatermarkData>, IValidatableObject
    {
        ...
        public ImageWatermarkData(string sourceFileName = default(string), bool useAsyncPattern = false, byte[] sourceFileContent = default(byte[]), byte[] imageFile = default(byte[]), SharepointFile sharepointFile = default(SharepointFile), PositionEnum position = PositionEnum.MiddleCenter, string width = default(string), string height = default(string), string x = default(string), string y = default(string), LayerEnum? layer = LayerEnum.Foreground, string rotation = default(string), string opacity = "100", string fillColor = default(string), string lineColor = default(string), string lineWidth = default(string), int startPage = default(int), int endPage = default(int), int pageInterval = default(int), PageOrientationEnum? pageOrientation = PageOrientationEnum.Both, PrintOnlyEnum? printOnly = PrintOnlyEnum.False, int startSection = default(int), int endSection = default(int), string pageType = default(string), bool failOnError = true)
        {
            ...
            {
                throw new ArgumentNullException("sourceFileContent is a required property for ImageWatermarkData and cannot be null");
            }
            this.SourceFileContent = sourceFileContent;
            // to ensure "imageFile" is required (not null)
            if (imageFile == null)
            {
                throw new ArgumentNullException("imageFile is a required property for ImageWatermarkData and cannot be null");
            }
            ...
            if (width == null)
            {
                throw new ArgumentNullException("width is a required property for ImageWatermarkData and cannot be null");
            }
            this.Width = width;
            // to ensure "height" is required (not null)
            if (height == null)
            {
                throw new ArgumentNullException("height is a required property for ImageWatermarkData and cannot be null");
            }
            this.Height = height;
        ...
        [DataMember(Name = "image_file", IsRequired = true, EmitDefaultValue = false)]
        ...
        {
            return this.Equals(input as ImageWatermarkData);
        }

        /// <summary>
        /// Returns true if ImageWatermarkData instances are equal
        /// </summary>
        /// <param name="input">Instance of ImageWatermarkData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ImageWatermarkData input)
        {
            if (input == null)
            {
                return false;
