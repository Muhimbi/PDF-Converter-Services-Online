...
namespace Muhimbi.PDF.Online.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "linear_barcode_watermark_data")]
    public partial class LinearBarcodeWatermarkData : IEquatable<LinearBarcodeWatermarkData>, IValidatableObject
    {
        ...
        public enum BarcodeTypeEnum
        {
            ...
            /// <summary>
            /// Enum Code11 for value: Code11
            /// </summary>
            [EnumMember(Value = "Code11")]
            Code11 = 2,

            /// <summary>
            /// Enum Code32 for value: Code32
            /// </summary>
            ...
            /// <summary>
            /// Enum Code39Extended for value: Code39Extended
            /// </summary>
            ...
            /// <summary>
            /// Enum Code93Extended for value: Code93Extended
            /// </summary>
            ...
            /// <summary>
            /// Enum Code128A for value: Code128A
            /// </summary>
            [EnumMember(Value = "Code128A")]
            Code128A = 9,

            /// <summary>
            /// Enum Code128B for value: Code128B
            /// </summary>
            [EnumMember(Value = "Code128B")]
            Code128B = 10,

            /// <summary>
            /// Enum Code128C for value: Code128C
            /// </summary>
            [EnumMember(Value = "Code128C")]
            Code128C = 11,

            /// <summary>
            /// Enum GS1Code128 for value: GS1Code128
            /// </summary>
        ...
        /// </summary>
        /// <value>The type of the barcode</value>
        [DataMember(Name = "barcode_type", IsRequired = true, EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>Flag indicating if the check digit has to be calculated or not</value>
        [DataMember(Name = "disable_checkdigit", IsRequired = true, EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>Flag indicating if the check digit should be displayed in the barcode label or not</value>
        [DataMember(Name = "show_checkdigit", IsRequired = true, EmitDefaultValue = false)]
        ...
        public LinearBarcodeWatermarkData(string sourceFileName = default(string), bool useAsyncPattern = false, byte[] sourceFileContent = default(byte[]), string content = default(string), SharepointFile sharepointFile = default(SharepointFile), BarcodeTypeEnum barcodeType = BarcodeTypeEnum.Codabar, OmitStartStopSymbolsEnum? omitStartStopSymbols = OmitStartStopSymbolsEnum.False, DisableCheckdigitEnum disableCheckdigit = DisableCheckdigitEnum.False, ShowCheckdigitEnum showCheckdigit = ShowCheckdigitEnum.False, string margin = default(string), string fontFamilyName = default(string), string fontSize = default(string), string fontStyle = default(string), LabelPlacementEnum? labelPlacement = LabelPlacementEnum.BottomCenter, PositionEnum position = PositionEnum.MiddleCenter, string width = default(string), string height = default(string), string x = default(string), string y = default(string), LayerEnum? layer = LayerEnum.Foreground, string rotation = default(string), string opacity = "100", string fillColor = default(string), string lineColor = default(string), int startPage = default(int), int endPage = default(int), int pageInterval = default(int), PageOrientationEnum? pageOrientation = PageOrientationEnum.Both, PrintOnlyEnum? printOnly = PrintOnlyEnum.False, int startSection = default(int), int endSection = default(int), string pageType = default(string), bool failOnError = true)
        {
            ...
            {
                throw new ArgumentNullException("sourceFileContent is a required property for LinearBarcodeWatermarkData and cannot be null");
            }
            this.SourceFileContent = sourceFileContent;
            // to ensure "content" is required (not null)
            if (content == null)
            {
                throw new ArgumentNullException("content is a required property for LinearBarcodeWatermarkData and cannot be null");
            }
            ...
            if (width == null)
            {
                throw new ArgumentNullException("width is a required property for LinearBarcodeWatermarkData and cannot be null");
            }
            this.Width = width;
            // to ensure "height" is required (not null)
            if (height == null)
            {
                throw new ArgumentNullException("height is a required property for LinearBarcodeWatermarkData and cannot be null");
            }
            this.Height = height;
        ...
        {
            return this.Equals(input as LinearBarcodeWatermarkData);
        }

        /// <summary>
        /// Returns true if LinearBarcodeWatermarkData instances are equal
        /// </summary>
        /// <param name="input">Instance of LinearBarcodeWatermarkData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LinearBarcodeWatermarkData input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.OmitStartStopSymbols == input.OmitStartStopSymbols ||
                    this.OmitStartStopSymbols.Equals(input.OmitStartStopSymbols)
                ) && 
                (
                    this.DisableCheckdigit == input.DisableCheckdigit ||
                    this.DisableCheckdigit.Equals(input.DisableCheckdigit)
                ) && 
                (
                    this.ShowCheckdigit == input.ShowCheckdigit ||
                    this.ShowCheckdigit.Equals(input.ShowCheckdigit)
                ) && 
                (
                ...
                (
                    this.LabelPlacement == input.LabelPlacement ||
                    this.LabelPlacement.Equals(input.LabelPlacement)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.OmitStartStopSymbols.GetHashCode();
                hashCode = (hashCode * 59) + this.DisableCheckdigit.GetHashCode();
                hashCode = (hashCode * 59) + this.ShowCheckdigit.GetHashCode();
                if (this.Margin != null)
                {
                ...
                hashCode = (hashCode * 59) + this.LabelPlacement.GetHashCode();
