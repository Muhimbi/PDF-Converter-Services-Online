...
namespace Muhimbi.PDF.Online.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "secure_pdf_data")]
    public partial class SecurePdfData : IEquatable<SecurePdfData>, IValidatableObject
    {
        ...
        public SecurePdfData(bool useAsyncPattern = false, string sourceFileName = default(string), byte[] sourceFileContent = default(byte[]), SharepointFile sharepointFile = default(SharepointFile), string openPassword = default(string), string ownerPassword = default(string), string securityOptions = default(string), bool failOnError = true)
        {
            ...
            {
                throw new ArgumentNullException("sourceFileContent is a required property for SecurePdfData and cannot be null");
            }
        ...
        {
            return this.Equals(input as SecurePdfData);
        }

        /// <summary>
        /// Returns true if SecurePdfData instances are equal
        /// </summary>
        /// <param name="input">Instance of SecurePdfData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SecurePdfData input)
        {
            if (input == null)
            {
                return false;
