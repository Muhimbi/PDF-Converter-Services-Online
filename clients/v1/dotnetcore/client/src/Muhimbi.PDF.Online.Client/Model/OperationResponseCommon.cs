...
namespace Muhimbi.PDF.Online.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "operation_response_common")]
    public partial class OperationResponseCommon : IEquatable<OperationResponseCommon>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as OperationResponseCommon);
        }

        /// <summary>
        /// Returns true if OperationResponseCommon instances are equal
        /// </summary>
        /// <param name="input">Instance of OperationResponseCommon to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OperationResponseCommon input)
        {
            if (input == null)
            {
                return false;
