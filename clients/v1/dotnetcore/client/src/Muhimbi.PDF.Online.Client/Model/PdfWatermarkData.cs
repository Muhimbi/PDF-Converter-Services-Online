...
namespace Muhimbi.PDF.Online.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "pdf_watermark_data")]
    public partial class PdfWatermarkData : IEquatable<PdfWatermarkData>, IValidatableObject
    {
        ...
        public PdfWatermarkData(string sourceFileName = default(string), bool useAsyncPattern = false, byte[] sourceFileContent = default(byte[]), byte[] pdfFile = default(byte[]), SharepointFile sharepointFile = default(SharepointFile), PositionEnum position = PositionEnum.MiddleCenter, string width = default(string), string height = default(string), string x = default(string), string y = default(string), LayerEnum? layer = LayerEnum.Foreground, string rotation = default(string), string opacity = "100", int startPage = default(int), int endPage = default(int), int pageInterval = default(int), PageOrientationEnum? pageOrientation = PageOrientationEnum.Both, PrintOnlyEnum? printOnly = PrintOnlyEnum.False, int startSection = default(int), int endSection = default(int), string pageType = default(string), bool failOnError = true)
        {
            ...
            {
                throw new ArgumentNullException("sourceFileContent is a required property for PdfWatermarkData and cannot be null");
            }
            this.SourceFileContent = sourceFileContent;
            // to ensure "pdfFile" is required (not null)
            if (pdfFile == null)
            {
                throw new ArgumentNullException("pdfFile is a required property for PdfWatermarkData and cannot be null");
            }
            ...
            if (width == null)
            {
                throw new ArgumentNullException("width is a required property for PdfWatermarkData and cannot be null");
            }
            this.Width = width;
            // to ensure "height" is required (not null)
            if (height == null)
            {
                throw new ArgumentNullException("height is a required property for PdfWatermarkData and cannot be null");
            }
            this.Height = height;
        ...
        [DataMember(Name = "pdf_file", IsRequired = true, EmitDefaultValue = false)]
        ...
        {
            return this.Equals(input as PdfWatermarkData);
        }

        /// <summary>
        /// Returns true if PdfWatermarkData instances are equal
        /// </summary>
        /// <param name="input">Instance of PdfWatermarkData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PdfWatermarkData input)
        {
            if (input == null)
            {
                return false;
