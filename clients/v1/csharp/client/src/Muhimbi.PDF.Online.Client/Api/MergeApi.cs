...
namespace Muhimbi.PDF.Online.Client.Api
{
    ...
    public interface IMergeApi : IApiAccessor
    {
        ...
        OperationResponse MergeToPdf (MergeToPdfData inputData);
        ...
        ApiResponse<OperationResponse> MergeToPdfWithHttpInfo (MergeToPdfData inputData);
        ...
        System.Threading.Tasks.Task<OperationResponse> MergeToPdfAsync (MergeToPdfData inputData);
        ...
        System.Threading.Tasks.Task<ApiResponse<OperationResponse>> MergeToPdfAsyncWithHttpInfo (MergeToPdfData inputData);
    ...
    public partial class MergeApi : IMergeApi
    {
        ...
        /// <param name="inputData"></param>
        /// <returns>ApiResponse of OperationResponse</returns>
        public ApiResponse< OperationResponse > MergeToPdfWithHttpInfo (MergeToPdfData inputData)
        {
