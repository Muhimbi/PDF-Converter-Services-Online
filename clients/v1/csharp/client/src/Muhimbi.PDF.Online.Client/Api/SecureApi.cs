...
namespace Muhimbi.PDF.Online.Client.Api
{
    ...
    public interface ISecureApi : IApiAccessor
    {
        ...
        OperationResponse SecureDocument (SecureDocumentData inputData);
        ...
        ApiResponse<OperationResponse> SecureDocumentWithHttpInfo (SecureDocumentData inputData);
        /// <summary>
        /// Secure document
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<OperationResponse> SecureDocumentAsync (SecureDocumentData inputData);
        ...
        System.Threading.Tasks.Task<ApiResponse<OperationResponse>> SecureDocumentAsyncWithHttpInfo (SecureDocumentData inputData);
        /// <summary>
        /// Secure document
        /// </summary>
        /// <remarks>
    ...
    public partial class SecureApi : ISecureApi
    {
        ...
        /// <param name="inputData"></param>
        /// <returns>OperationResponse</returns>
        public OperationResponse SecureDocument (SecureDocumentData inputData)
        {
             ApiResponse<OperationResponse> localVarResponse = SecureDocumentWithHttpInfo(inputData);
        ...
        /// <param name="inputData"></param>
        /// <returns>ApiResponse of OperationResponse</returns>
        public ApiResponse< OperationResponse > SecureDocumentWithHttpInfo (SecureDocumentData inputData)
        {
            // verify the required parameter 'inputData' is set
            if (inputData == null)
                throw new ApiException(400, "Missing required parameter 'inputData' when calling SecureApi->SecureDocument");

            var localVarPath = "/v1/operations/secure_document";
            ...
            {
                Exception exception = ExceptionFactory("SecureDocument", localVarResponse);
        ...
        /// <param name="inputData"></param>
        /// <returns>Task of OperationResponse</returns>
        public async System.Threading.Tasks.Task<OperationResponse> SecureDocumentAsync (SecureDocumentData inputData)
        {
             ApiResponse<OperationResponse> localVarResponse = await SecureDocumentAsyncWithHttpInfo(inputData);
             return localVarResponse.Data;
        ...
        /// <param name="inputData"></param>
        /// <returns>Task of ApiResponse (OperationResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<OperationResponse>> SecureDocumentAsyncWithHttpInfo (SecureDocumentData inputData)
        {
            // verify the required parameter 'inputData' is set
            if (inputData == null)
                throw new ApiException(400, "Missing required parameter 'inputData' when calling SecureApi->SecureDocument");
