...
namespace Muhimbi.PDF.Online.Client.Model
{
    ...
    public partial class SplitOperationResponse :  IEquatable<SplitOperationResponse>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="ProcessedFileContents">Files generated by the Muhimbi converter..</param>
        ...
        public SplitOperationResponse(List<byte[]> ProcessedFileContents = default(List<byte[]>), string BaseFileName = default(string), ResultCodeEnum? ResultCode = default(ResultCodeEnum?), string ResultDetails = default(string))
        {
        ...
        [DataMember(Name="processed_file_contents", EmitDefaultValue=false)]
        public List<byte[]> ProcessedFileContents { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ProcessedFileContents: ").Append(ProcessedFileContents).Append("\n");
        ...
        public bool Equals(SplitOperationResponse other)
        {
            ...
            return 
                (
                    this.ProcessedFileContents == other.ProcessedFileContents ||
                    this.ProcessedFileContents != null &&
                    this.ProcessedFileContents.SequenceEqual(other.ProcessedFileContents)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ProcessedFileContents != null)
                    hash = hash * 59 + this.ProcessedFileContents.GetHashCode();
