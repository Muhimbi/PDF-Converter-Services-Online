...
namespace Muhimbi.PDF.Online.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EllipseWatermarkData :  IEquatable<EllipseWatermarkData>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EllipseWatermarkData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EllipseWatermarkData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EllipseWatermarkData" /> class.
        /// </summary>
        ...
        public EllipseWatermarkData(string SourceFileName = default(string), bool? UseAsyncPattern = false, byte[] SourceFileContent = default(byte[]), PositionEnum? Position = PositionEnum.MiddleCenter, SharepointFile SharepointFile = default(SharepointFile), string Width = default(string), string Height = default(string), string X = default(string), string Y = default(string), LayerEnum? Layer = LayerEnum.Foreground, string Rotation = default(string), string Opacity = "100", string FillColor = default(string), string LineColor = default(string), string LineWidth = default(string), int? StartPage = default(int?), int? EndPage = default(int?), int? PageInterval = default(int?), PageOrientationEnum? PageOrientation = PageOrientationEnum.Both, bool? FailOnError = true)
        {
            ...
            if (Position == null)
            {
                throw new InvalidDataException("Position is a required property for EllipseWatermarkData and cannot be null");
            }
            else
            {
            ...
            if (Width == null)
            {
                throw new InvalidDataException("Width is a required property for EllipseWatermarkData and cannot be null");
            }
            else
            {
                this.Width = Width;
            ...
            if (Height == null)
            {
                throw new InvalidDataException("Height is a required property for EllipseWatermarkData and cannot be null");
            }
            else
            {
                this.Height = Height;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as EllipseWatermarkData);
        }

        /// <summary>
        /// Returns true if EllipseWatermarkData instances are equal
        /// </summary>
        /// <param name="other">Instance of EllipseWatermarkData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EllipseWatermarkData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
