...
namespace Muhimbi.PDF.Online.Client.Model
{
    ...
    public partial class ConvertVisioData :  IEquatable<ConvertVisioData>, IValidatableObject
    {
        ...
        public ConvertVisioData(bool? UseAsyncPattern = false, string SourceFileName = default(string), SharepointFile SharepointFile = default(SharepointFile), byte[] SourceFileContent = default(byte[]), OutputFormatEnum? OutputFormat = OutputFormatEnum.PDF, bool? CopyMetadata = false, RangeEnum? Range = default(RangeEnum?), int? StartPage = default(int?), int? EndPage = default(int?), QualityEnum? Quality = default(QualityEnum?), string OverrideSettings = default(string), bool? FailOnError = true)
        {
            ...
            {
                throw new InvalidDataException("UseAsyncPattern is a required property for ConvertVisioData and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("SourceFileName is a required property for ConvertVisioData and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("SourceFileContent is a required property for ConvertVisioData and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("OutputFormat is a required property for ConvertVisioData and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("CopyMetadata is a required property for ConvertVisioData and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConvertVisioData);
        }

        /// <summary>
        /// Returns true if ConvertVisioData instances are equal
        /// </summary>
        /// <param name="other">Instance of ConvertVisioData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConvertVisioData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
