...
namespace Muhimbi.PDF.Online.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConvertPowerpointData :  IEquatable<ConvertPowerpointData>, IValidatableObject
    {
        /// <summary>
        /// Output format
        /// </summary>
        ...
        /// </summary>
        /// <value>Specify how you would like the output to be arranged</value>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum PrintOutputTypeEnum
        {
            
            /// <summary>
            /// Enum Slides for "Slides"
            /// </summary>
            [EnumMember(Value = "Slides")]
            Slides,
            
            /// <summary>
            /// Enum OneSlideHandouts for "OneSlideHandouts"
            /// </summary>
            [EnumMember(Value = "OneSlideHandouts")]
            OneSlideHandouts,
            
            /// <summary>
            /// Enum TwoSlideHandouts for "TwoSlideHandouts"
            /// </summary>
            [EnumMember(Value = "TwoSlideHandouts")]
            TwoSlideHandouts,
            
            /// <summary>
            /// Enum ThreeSlideHandouts for "ThreeSlideHandouts"
            /// </summary>
            [EnumMember(Value = "ThreeSlideHandouts")]
            ThreeSlideHandouts,
            
            /// <summary>
            /// Enum FourSlideHandouts for "FourSlideHandouts"
            /// </summary>
            [EnumMember(Value = "FourSlideHandouts")]
            FourSlideHandouts,
            
            /// <summary>
            /// Enum SixSlideHandouts for "SixSlideHandouts"
            /// </summary>
            [EnumMember(Value = "SixSlideHandouts")]
            SixSlideHandouts,
            
            /// <summary>
            /// Enum NineSlideHandouts for "NineSlideHandouts"
            /// </summary>
            [EnumMember(Value = "NineSlideHandouts")]
            NineSlideHandouts,
            
            /// <summary>
            /// Enum NotesPages for "NotesPages"
            /// </summary>
            [EnumMember(Value = "NotesPages")]
            NotesPages,
        ...
        /// </summary>
        /// <value>Specify how you would like the output to be arranged</value>
        [DataMember(Name="print_output_type", EmitDefaultValue=false)]
        public PrintOutputTypeEnum? PrintOutputType { get; set; }
        /// <summary>
        /// Quality of the output file
        /// </summary>
        /// <value>Quality of the output file</value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ConvertPowerpointData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ConvertPowerpointData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ConvertPowerpointData" /> class.
        /// </summary>
        ...
        /// <param name="PrintOutputType">Specify how you would like the output to be arranged (default to PrintOutputTypeEnum.Slides).</param>
        /// <param name="FrameSlides">Include a frame / border around the slides (default to true).</param>
        ...
        public ConvertPowerpointData(bool? UseAsyncPattern = false, string SourceFileName = default(string), SharepointFile SharepointFile = default(SharepointFile), byte[] SourceFileContent = default(byte[]), OutputFormatEnum? OutputFormat = OutputFormatEnum.PDF, bool? CopyMetadata = false, RangeEnum? Range = default(RangeEnum?), PrintOutputTypeEnum? PrintOutputType = PrintOutputTypeEnum.Slides, bool? FrameSlides = true, int? StartPage = default(int?), int? EndPage = default(int?), QualityEnum? Quality = default(QualityEnum?), string OverrideSettings = default(string), bool? FailOnError = true)
        {
            // to ensure "UseAsyncPattern" is required (not null)
            if (UseAsyncPattern == null)
            {
                throw new InvalidDataException("UseAsyncPattern is a required property for ConvertPowerpointData and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("SourceFileName is a required property for ConvertPowerpointData and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("SourceFileContent is a required property for ConvertPowerpointData and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("OutputFormat is a required property for ConvertPowerpointData and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("CopyMetadata is a required property for ConvertPowerpointData and cannot be null");
            }
            else
            {
            ...
            this.Range = Range;
            // use default value if no "PrintOutputType" provided
            if (PrintOutputType == null)
            {
                this.PrintOutputType = PrintOutputTypeEnum.Slides;
            }
            else
            {
                this.PrintOutputType = PrintOutputType;
            }
            // use default value if no "FrameSlides" provided
            if (FrameSlides == null)
            {
        ...
        /// </summary>
        /// <value>Include a frame / border around the slides</value>
        [DataMember(Name="frame_slides", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PrintOutputType: ").Append(PrintOutputType).Append("\n");
            sb.Append("  FrameSlides: ").Append(FrameSlides).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConvertPowerpointData);
        }

        /// <summary>
        /// Returns true if ConvertPowerpointData instances are equal
        /// </summary>
        /// <param name="other">Instance of ConvertPowerpointData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConvertPowerpointData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.PrintOutputType == other.PrintOutputType ||
                    this.PrintOutputType != null &&
                    this.PrintOutputType.Equals(other.PrintOutputType)
                ) && 
                (
                    this.FrameSlides == other.FrameSlides ||
                    this.FrameSlides != null &&
                    this.FrameSlides.Equals(other.FrameSlides)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PrintOutputType != null)
                    hash = hash * 59 + this.PrintOutputType.GetHashCode();
                if (this.FrameSlides != null)
                    hash = hash * 59 + this.FrameSlides.GetHashCode();
