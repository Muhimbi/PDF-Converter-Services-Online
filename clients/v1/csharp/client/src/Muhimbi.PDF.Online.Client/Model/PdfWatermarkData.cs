...
namespace Muhimbi.PDF.Online.Client.Model
{
    ...
    public partial class PdfWatermarkData :  IEquatable<PdfWatermarkData>, IValidatableObject
    {
        ...
        public PdfWatermarkData(string SourceFileName = default(string), bool? UseAsyncPattern = false, byte[] SourceFileContent = default(byte[]), byte[] PdfFile = default(byte[]), SharepointFile SharepointFile = default(SharepointFile), PositionEnum? Position = PositionEnum.MiddleCenter, string Width = default(string), string Height = default(string), string X = default(string), string Y = default(string), LayerEnum? Layer = LayerEnum.Foreground, string Rotation = default(string), string Opacity = "100", int? StartPage = default(int?), int? EndPage = default(int?), int? PageInterval = default(int?), PageOrientationEnum? PageOrientation = PageOrientationEnum.Both, bool? FailOnError = true)
        {
