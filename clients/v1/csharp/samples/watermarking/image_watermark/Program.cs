        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                ImageWatermarkData inputData = new ImageWatermarkData(
                    ...
                    ImageFile: System.Text.Encoding.UTF8.GetBytes("http://api.muhimbi.com/apple-touch-icon.png"),   // ** The image to use in the watermark, either a full URL or contents of a file.
                    Position: ImageWatermarkData.PositionEnum.MiddleCenter,         // ** The location where the watermark will be positioned on the page.
                    ...
                    Layer: ImageWatermarkData.LayerEnum.Foreground,                 // ** Position the watermark in front of the page's content, or behind it
                ...
                var response = watermarkAPI.ImageWatermark(inputData);
