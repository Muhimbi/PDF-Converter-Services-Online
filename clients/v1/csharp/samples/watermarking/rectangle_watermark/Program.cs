        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                RectangleWatermarkData inputData = new RectangleWatermarkData(
                    ...
                    Position: RectangleWatermarkData.PositionEnum.MiddleCenter,         // ** The location where the watermark will be positioned on the page.
                    ...
                    Layer: RectangleWatermarkData.LayerEnum.Foreground,                 // ** Position the watermark in front of the page's content, or behind it
                    ...
                    PageOrientation: RectangleWatermarkData.PageOrientationEnum.Both,   // ** The page orientation the watermark applies to. 
                    PrintOnly: RectangleWatermarkData.PrintOnlyEnum.False               // ** If set to true then watermarks only appear during print
                    );

                // ** Watermark the file
                Console.WriteLine("[INFO] Watermarking...");
                var response = watermarkAPI.RectangleWatermark(inputData);
