# Sample - Merge Files and HTML to PDF using C#
...
Once the sample has completed the merge process, it will attempt to launch the generated PDF in the system's default PDF Viewer. If this is not configured (or not possible under Linux) then the generated PDF file can be found in the `bin/Debug` folder.
