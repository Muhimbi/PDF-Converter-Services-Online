# Sample - Merge Files and HTML to PDF using using Java

The Java sample provided in this section uses the [*Muhimbi PDF Converter Services Online*](https://github.com/Muhimbi/PDF-Converter-Services-Online)  to convert (if needed) and merge multiple files and HTML into a single PDF.
...
Once the sample has completed the file merge process, the results are written to `result.pdf`. Open it in your favourite PDF reader to have a look.
