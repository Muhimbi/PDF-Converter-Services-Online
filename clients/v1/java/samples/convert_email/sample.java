...
public class sample {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            byte[] sourceFile = Files.readAllBytes(new File("sample.msg").toPath());

            // ** Fill out all data for this operation
            ConvertEmailData inputData = new ConvertEmailData();
            inputData.setSourceFileName("sample.msg");          // ** Always specify a file name with the correct extension
            ...
            OperationResponse result = apiInstance.convertEmail(inputData);
