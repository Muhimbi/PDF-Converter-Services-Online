# Sample - Splitting PDF files using Java

The Java sample provided in this section uses the [*Muhimbi PDF Converter Services Online*](https://github.com/Muhimbi/PDF-Converter-Services-Online) to split up a single PDF into multiple smaller ones.
