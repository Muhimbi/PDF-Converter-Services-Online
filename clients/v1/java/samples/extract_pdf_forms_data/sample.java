...
public class sample {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            inputData.setSourceFileName("Test.pdf");                        // ** Always specify a file name with the correct extension
            inputData.setOutputFormat(ConvertData.OutputFormatEnum.XFDF);   // ** The format to convert the file to (not all combinations are supported, see https://support.muhimbi.com/hc/en-us/articles/228089047-What-file-formats-types-are-supported-for-conversion-)
            ...
            FileOutputStream fos = new FileOutputStream("Data.xfdf");
            fos.write(decode(result.getProcessedFileContent()));
            fos.close();

            System.out.println("[INFO] 'Data.xfdf' written to output folder.");
