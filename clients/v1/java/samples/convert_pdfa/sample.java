...
public class sample {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            ConvertPdfaData inputData = new ConvertPdfaData();
            ...
            inputData.setPdfProfile(ConvertPdfaData.PdfProfileEnum.PDF_A2B); // ** The PDF profile to use for conversion
            ...
            OperationResponse result = apiInstance.convertPdfa(inputData);
