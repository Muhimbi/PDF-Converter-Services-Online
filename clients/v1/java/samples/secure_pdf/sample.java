...
public class sample {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            inputData.setOwnerPassword("owner");                    // ** When applying security restrictions (e.g. 'Print|ContentCopy'), always specify an 'owner password', 
            ...
            OperationResponse result = apiInstance.securePdf(inputData);
