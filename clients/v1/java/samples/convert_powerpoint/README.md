# Sample - Convert Microsoft PowerPoint documents to PDF using Java

The Java sample provided in this section uses the [*Muhimbi PDF Converter Services Online*](https://github.com/Muhimbi/PDF-Converter-Services-Online) to convert PowerPoint documents to PDF (and other formats).
