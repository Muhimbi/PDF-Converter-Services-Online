...
public class sample {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            inputData.setPosition(LineWatermarkData.PositionEnum.MIDDLE_CENTER);            // ** The location where the watermark will be positioned on the page.
            inputData.setX("72");                                                           // ** The x-coordinate of the watermark. Only used when Position is set to Absolute.
            inputData.setY("72");                                                           // ** The y-coordinate of the watermark. Only used when Position is set to Absolute.
            inputData.setEndX("523");                                                       // ** The end x-coordinate of the line in pts (1/72nd of an inch). 
            inputData.setEndY("770");                                                       // ** The end y-coordinate of the line in pts (1/72nd of an inch). 
            inputData.setLayer(LineWatermarkData.LayerEnum.FOREGROUND);                     // ** Position the watermark in front of the page's content, or behind it
            ...
            inputData.setPageOrientation(LineWatermarkData.PageOrientationEnum.BOTH);       // ** The page orientation the watermark applies to. 

            // ** Carry out the operation
            System.out.println("[INFO] Processing...");
            OperationResponse result = apiInstance.lineWatermark(inputData);
