...
public class sample {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            inputData.setPdfFile("http://www.muhimbi.com/Images---Files/PDFConverter/PDF-Converter-Brochure.aspx");   // ** The PDF to use in the watermark, either a full URL or contents of a file. (The first page in the PDF will be used as the watermark)
            inputData.setPosition(PdfWatermarkData.PositionEnum.MIDDLE_CENTER);             // ** The location where the watermark will be positioned on the page.
            ...
            inputData.setLayer(PdfWatermarkData.LayerEnum.FOREGROUND);                      // ** Position the watermark in front of the page's content, or behind it
            ...
            inputData.setPageOrientation(PdfWatermarkData.PageOrientationEnum.BOTH);        // ** The page orientation the watermark applies to. 

            // ** Carry out the operation
            System.out.println("[INFO] Processing...");
            OperationResponse result = apiInstance.pdfWatermark(inputData);
