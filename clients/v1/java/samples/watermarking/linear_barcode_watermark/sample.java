...
public class sample {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            inputData.setContent("123456789012");                                               // ** Data to embed in the barcode
            inputData.setBarcodeType(LinearBarcodeWatermarkData.BarcodeTypeEnum.UPC_A);         // ** Set barcode type
            inputData.setPosition(LinearBarcodeWatermarkData.PositionEnum.MIDDLE_CENTER);       // ** The location where the watermark will be positioned on the page.
            ...
            inputData.setWidth("300");                                                          // ** The width of the watermark in pts (1/72nd of an inch). For example 144 is 2 inches wide.
            inputData.setHeight("200");                                                         // ** The height of the watermark.
            inputData.setLayer(LinearBarcodeWatermarkData.LayerEnum.FOREGROUND);                // ** Position the watermark in front of the page's content, or behind it
            inputData.setRotation("0");                                                         // ** Rotate the watermark, specify a value in degrees. Negative values are accepted.
            inputData.setOpacity("100");                                                         // ** A value between 0 (completely transparent) and 100 (fully visible)
            ...
            inputData.setPageOrientation(LinearBarcodeWatermarkData.PageOrientationEnum.BOTH);  // ** The page orientation the watermark applies to. 

            // ** Carry out the operation
            System.out.println("[INFO] Processing...");
            OperationResponse result = apiInstance.linearBarcodeWatermark(inputData);
