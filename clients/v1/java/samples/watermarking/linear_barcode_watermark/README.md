# Sample - Apply a Linear Barcode watermark to PDF using Java

The Java sample provided in this section uses the [*Muhimbi PDF Converter Services Online*](https://github.com/Muhimbi/PDF-Converter-Services-Online) to apply a Linear Barcode, as a watermark, to a PDF file. 
