...
public class sample {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            ImageWatermarkData inputData = new ImageWatermarkData();
            ...
            inputData.setImageFile("http://api.muhimbi.com/apple-touch-icon.png");          // ** The image to use in the watermark, either a full URL or contents of a file.
            inputData.setPosition(ImageWatermarkData.PositionEnum.MIDDLE_CENTER);           // ** The location where the watermark will be positioned on the page.
            ...
            inputData.setLayer(ImageWatermarkData.LayerEnum.FOREGROUND);                    // ** Position the watermark in front of the page's content, or behind it
            ...
            inputData.setPageOrientation(ImageWatermarkData.PageOrientationEnum.BOTH);      // ** The page orientation the watermark applies to. 

            // ** Carry out the operation
            System.out.println("[INFO] Processing...");
            OperationResponse result = apiInstance.imageWatermark(inputData);
