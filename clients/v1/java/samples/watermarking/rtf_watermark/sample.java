...
public class sample {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            inputData.setPosition(RtfWatermarkData.PositionEnum.MIDDLE_CENTER);             // ** The location where the watermark will be positioned on the page.
            inputData.setRtfData("{\\rtf1\\ansi\\deff0" +                                   // ** Specify the RTF text, see http://search.cpan.org/~sburke/RTF-Writer-1.11/lib/RTF/Cookbook.pod for examples
            ...
            inputData.setLayer(RtfWatermarkData.LayerEnum.FOREGROUND);                      // ** Position the watermark in front of the page's content, or behind it
            ...
            inputData.setLineWidth(null);                                                   // ** The width of the line in pts (1/72nd of an inch). 0 = hairline, -1 = no line
            ...
            inputData.setPageOrientation(RtfWatermarkData.PageOrientationEnum.BOTH);        // ** The page orientation the watermark applies to. 

            // ** Carry out the operation
            System.out.println("[INFO] Processing...");
            OperationResponse result = apiInstance.rtfWatermark(inputData);
