...
public class sample {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            inputData.setPosition(EllipseWatermarkData.PositionEnum.MIDDLE_CENTER);         // ** The location where the watermark will be positioned on the page.
            ...
            inputData.setLayer(EllipseWatermarkData.LayerEnum.FOREGROUND);                  // ** Position the watermark in front of the page's content, or behind it
            ...
            inputData.setPageOrientation(EllipseWatermarkData.PageOrientationEnum.BOTH);    // ** The page orientation the watermark applies to. 

            // ** Carry out the operation
            System.out.println("[INFO] Processing...");
            OperationResponse result = apiInstance.ellipseWatermark(inputData);
