...
import com.muhimbi.online.client.auth.Authentication;
import com.muhimbi.online.client.auth.HttpBasicAuth;
import com.muhimbi.online.client.auth.ApiKeyAuth;
import com.muhimbi.online.client.auth.OAuth;
...
public class ApiClient {
    ...
    private String basePath = "https://api.muhimbi.com/api";
    ...
    public ApiClient() {
        ...
        setUserAgent("Swagger-Codegen/9.15.0/java");

        // Setup authentications (key: authentication name, value: authentication).
        authentications = new HashMap<String, Authentication>();
        authentications.put("api_key", new ApiKeyAuth("header", "api_key"));
        authentications.put("oauth2_auth", new OAuth());
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.muhimbi.com/api
