...
public class RtfWatermarkData {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(sourceFileName, useAsyncPattern, sourceFileContent, rtfData, sharepointFile, position, width, height, x, y, layer, rotation, opacity, fillColor, lineColor, lineWidth, startPage, endPage, pageInterval, pageOrientation, failOnError);
  }
