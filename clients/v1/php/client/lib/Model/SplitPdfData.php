...
class SplitPdfData implements ArrayAccess
{
    ...
    const FILE_SPLIT_TYPE_BY_NUMBER_OF_PAGES = 'ByNumberOfPages';
    const FILE_SPLIT_TYPE_BY_BOOKMARK_LEVEL = 'ByBookmarkLevel';
     ...
     * @return string[]
     */
    public function getFileSplitTypeAllowableValues()
    {
        return [
            self::FILE_SPLIT_TYPE_BY_NUMBER_OF_PAGES,
            self::FILE_SPLIT_TYPE_BY_BOOKMARK_LEVEL,
        ];
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['file_split_type'] === null) {
            $invalid_properties[] = "'file_split_type' can't be null";
        }
        $allowed_values = ["ByNumberOfPages", "ByBookmarkLevel"];
        if (!in_array($this->container['file_split_type'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'file_split_type', must be one of 'ByNumberOfPages', 'ByBookmarkLevel'.";
        }
    ...
    /**
     * Gets file_split_type
     * @return string
     */
    public function getFileSplitType()
    {
        return $this->container['file_split_type'];
    }

    /**
     * Sets file_split_type
     * @param string $file_split_type Split by option
     * @return $this
     */
    public function setFileSplitType($file_split_type)
    {
        $allowed_values = array('ByNumberOfPages', 'ByBookmarkLevel');
        if ((!in_array($file_split_type, $allowed_values))) {
            throw new \InvalidArgumentException("Invalid value for 'file_split_type', must be one of 'ByNumberOfPages', 'ByBookmarkLevel'");
        }
        $this->container['file_split_type'] = $file_split_type;
     ...
     * @param int $split_parameter Split parameters
     * @return $this
     */
