...
/**
 * RtfWatermarkData Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class RtfWatermarkData implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'rtf_watermark_data';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['rtf_data'] = isset($data['rtf_data']) ? $data['rtf_data'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['rtf_data'] === null) {
            $invalid_properties[] = "'rtf_data' can't be null";
        }
    ...
    {
        return $this->container['rtf_data'];
    }

    /**
     * Sets rtf_data
     * @param string $rtf_data Watermark text in RTF format
     * @return $this
     */
    public function setRtfData($rtf_data)
    {
        $this->container['rtf_data'] = $rtf_data;
