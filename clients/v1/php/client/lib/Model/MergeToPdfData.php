...
class MergeToPdfData implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['source_file_name_1'] === null) {
            $invalid_properties[] = "'source_file_name_1' can't be null";
        }
        if ($this->container['source_file_content_1'] === null) {
            $invalid_properties[] = "'source_file_content_1' can't be null";
        }
        if ($this->container['source_file_name_2'] === null) {
            $invalid_properties[] = "'source_file_name_2' can't be null";
        }
        if ($this->container['source_file_content_2'] === null) {
            $invalid_properties[] = "'source_file_content_2' can't be null";
        }
