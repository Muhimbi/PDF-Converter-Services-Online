 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class OcrPdfData implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ocr_pdf_data';
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = ["English", "Arabic", "Danish", "German", "Dutch", "Finnish", "French", "Hebrew", "Hungarian", "Italian", "Norwegian", "Portuguese", "Spanish", "Swedish"];
        if (!in_array($this->container['language'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'language', must be one of 'English', 'Arabic', 'Danish', 'German', 'Dutch', 'Finnish', 'French', 'Hebrew', 'Hungarian', 'Italian', 'Norwegian', 'Portuguese', 'Spanish', 'Swedish'.";
        }
    ...
    /**
     * Sets copy_metadata
     * @param bool $copy_metadata Copy metadata (For SharePoint only)
     * @return $this
     */
    ...
    {
        $allowed_values = array('English', 'Arabic', 'Danish', 'German', 'Dutch', 'Finnish', 'French', 'Hebrew', 'Hungarian', 'Italian', 'Norwegian', 'Portuguese', 'Spanish', 'Swedish');
        if (!is_null($language) && (!in_array($language, $allowed_values))) {
            throw new \InvalidArgumentException("Invalid value for 'language', must be one of 'English', 'Arabic', 'Danish', 'German', 'Dutch', 'Finnish', 'French', 'Hebrew', 'Hungarian', 'Italian', 'Norwegian', 'Portuguese', 'Spanish', 'Swedish'");
        }
    ...
    /**
     * Sets regions
     * @param string $regions Limit the area to OCR to one or more specific areas
     * @return $this
     */
