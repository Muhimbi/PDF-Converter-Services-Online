...
class ConvertData implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = ["PDF", "XPS", "DOCX", "DOC", "ODT", "RTF", "TXT", "MHT", "HTML", "XML", "XLS", "XLSX", "CSV", "ODS", "PPT", "PPTX", "ODP", "PPS", "PPSX", "TIFF", "PNG", "GIF", "JPG", "BMP", "PS", "PCL", "EPS", "FDF", "XFDF"];
        if (!in_array($this->container['output_format'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'output_format', must be one of 'PDF', 'XPS', 'DOCX', 'DOC', 'ODT', 'RTF', 'TXT', 'MHT', 'HTML', 'XML', 'XLS', 'XLSX', 'CSV', 'ODS', 'PPT', 'PPTX', 'ODP', 'PPS', 'PPSX', 'TIFF', 'PNG', 'GIF', 'JPG', 'BMP', 'PS', 'PCL', 'EPS', 'FDF', 'XFDF'.";
        }
    ...
    {
        $allowed_values = array('PDF', 'XPS', 'DOCX', 'DOC', 'ODT', 'RTF', 'TXT', 'MHT', 'HTML', 'XML', 'XLS', 'XLSX', 'CSV', 'ODS', 'PPT', 'PPTX', 'ODP', 'PPS', 'PPSX', 'TIFF', 'PNG', 'GIF', 'JPG', 'BMP', 'PS', 'PCL', 'EPS', 'FDF', 'XFDF');
        if ((!in_array($output_format, $allowed_values))) {
            throw new \InvalidArgumentException("Invalid value for 'output_format', must be one of 'PDF', 'XPS', 'DOCX', 'DOC', 'ODT', 'RTF', 'TXT', 'MHT', 'HTML', 'XML', 'XLS', 'XLSX', 'CSV', 'ODS', 'PPT', 'PPTX', 'ODP', 'PPS', 'PPSX', 'TIFF', 'PNG', 'GIF', 'JPG', 'BMP', 'PS', 'PCL', 'EPS', 'FDF', 'XFDF'");
        }
