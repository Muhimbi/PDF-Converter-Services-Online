...
/**
 * OcrOperationResponse Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class OcrOperationResponse implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ocr_operation_response';
    ...
    {
        $this->container['out_text'] = isset($data['out_text']) ? $data['out_text'] : null;
     ...
     * @return string
     */
    public function getOutText()
    {
        return $this->container['out_text'];
    }

    /**
     * Sets out_text
     * @param string $out_text Extracted OCRed text in plain text.
     * @return $this
     */
    public function setOutText($out_text)
    {
        $this->container['out_text'] = $out_text;
