...
/**
 * ConvertVisioData Class Doc Comment
 *
 * @category    Class
 * @description Parameters for Convert Visio operation
 * @package     MuhimbiPDFOnline\Client
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ConvertVisioData implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'convert_visio_data';
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = ["PDF", "XPS"];
        if (!in_array($this->container['output_format'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'output_format', must be one of 'PDF', 'XPS'.";
        }

        if ($this->container['copy_metadata'] === null) {
            $invalid_properties[] = "'copy_metadata' can't be null";
        }
        $allowed_values = ["AllDocuments", "ActiveDocuments"];
        if (!in_array($this->container['range'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'range', must be one of 'AllDocuments', 'ActiveDocuments'.";
        }
    ...
    {
        $allowed_values = array('PDF', 'XPS');
        if ((!in_array($output_format, $allowed_values))) {
            throw new \InvalidArgumentException("Invalid value for 'output_format', must be one of 'PDF', 'XPS'");
        }
    ...
    /**
     * Sets range
     * @param string $range Specify which parts of the file to render
     * @return $this
     */
    public function setRange($range)
    {
        $allowed_values = array('AllDocuments', 'ActiveDocuments');
        if (!is_null($range) && (!in_array($range, $allowed_values))) {
            throw new \InvalidArgumentException("Invalid value for 'range', must be one of 'AllDocuments', 'ActiveDocuments'");
        }
