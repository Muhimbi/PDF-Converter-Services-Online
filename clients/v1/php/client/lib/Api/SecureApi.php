...
class SecureApi
{
    ...
    /**
     * Operation secureDocument
     *
     * 
     *
     * @param \MuhimbiPDFOnline\Client\Model\SecureDocumentData $input_data  (required)
     * @throws \MuhimbiPDFOnline\Client\ApiException on non-2xx response
     * @return \MuhimbiPDFOnline\Client\Model\OperationResponse
     */
    public function secureDocument($input_data)
    {
        list($response) = $this->secureDocumentWithHttpInfo($input_data);
        return $response;
    }

    /**
     * Operation secureDocumentWithHttpInfo
     *
     * 
     *
     * @param \MuhimbiPDFOnline\Client\Model\SecureDocumentData $input_data  (required)
     ...
     */
    public function secureDocumentWithHttpInfo($input_data)
    {
        // verify the required parameter 'input_data' is set
        if ($input_data === null) {
            throw new \InvalidArgumentException('Missing the required parameter $input_data when calling secureDocument');
        }
        // parse inputs
        $resourcePath = "/v1/operations/secure_document";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
     ...
     * Secure document
     *
     * @param \MuhimbiPDFOnline\Client\Model\SecurePdfData $input_data  (required)
     * @throws \MuhimbiPDFOnline\Client\ApiException on non-2xx response
     * @return \MuhimbiPDFOnline\Client\Model\OperationResponse
     */
    public function securePdf($input_data)
    {
        list($response) = $this->securePdfWithHttpInfo($input_data);
        return $response;
    }

    /**
     * Operation securePdfWithHttpInfo
     *
     * Secure document
     *
     * @param \MuhimbiPDFOnline\Client\Model\SecurePdfData $input_data  (required)
     ...
     * @return array of \MuhimbiPDFOnline\Client\Model\OperationResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function securePdfWithHttpInfo($input_data)
    {
        // verify the required parameter 'input_data' is set
        if ($input_data === null) {
            throw new \InvalidArgumentException('Missing the required parameter $input_data when calling securePdf');
        }
        // parse inputs
        $resourcePath = "/v1/operations/secure_pdf";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
