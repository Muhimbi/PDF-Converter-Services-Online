...
if($_FILES["file"]['size'] > 0)
{
    ...
    $input_data = new MuhimbiPDFOnline\Client\Model\ConvertCadData();
    ...
    $input_data->setForegroundColor($_POST["foregroundColor"]);
    ...
    try { 
        ...
        $result = $api_instance->convertCad($input_data);
...
<html>
  <body>
    <form action="sample.php" method="post" enctype="multipart/form-data">
      ...
      Foreground color: <select name="foregroundColor">
        <option value="Default">Default</option>
        <option value="CorrectForBackground">CorrectForBackground</option>
        <option value="Greyscale">Greyscale</option>
        <option value="GreyscaleDarken">GreyscaleDarken</option>
        <option value="GreyscaleLighten">GreyscaleLighten</option>
      ...
      <br/><br>
      <input type="submit" value="Convert CAD file" />
    </form>
  </body>
</html>