# Sample - Convert file to PDF/A using PHP

The PHP sample provided in this section uses the [*Muhimbi PDF Converter Services Online*](https://github.com/Muhimbi/PDF-Converter-Services-Online) to convert uploaded documents to PDF of the selected PDF profile.
