...
if($_FILES["file"]['size'] > 0)
{
    ...
    $input_data = new MuhimbiPDFOnline\Client\Model\ConvertEmailData();
    ...
    try { 
        ...
        $result = $api_instance->convertEmail($input_data);
...
<html>
  <body>
    <form action="sample.php" method="post" enctype="multipart/form-data">
      <input type="file" name="file" accept=".msg,.eml"/>

      <br/><br>
      <input type="submit" value="Convert Email" />
    </form>
  </body>
</html>