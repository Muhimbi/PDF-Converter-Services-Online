...
if($_FILES["file"]['size'] > 0)
{
    ...
    $input_data = new MuhimbiPDFOnline\Client\Model\ImageWatermarkData();
    ...
    // ** The image to use in the watermark, either a full URL or base64 encoded file.
    $input_data->setImageFile('http://api.muhimbi.com/apple-touch-icon.png');
    ...
    try { 
        ...
        $result = $api_instance->imageWatermark($input_data);
...
<html>
  <body>
    <form action="image_watermark.php" method="post" enctype="multipart/form-data">
