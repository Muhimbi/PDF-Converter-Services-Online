...
if($_FILES["file"]['size'] > 0)
{
    ...
    $input_data = new MuhimbiPDFOnline\Client\Model\RtfWatermarkData();
    ...
    $input_data->setRtfData('{\rtf1\ansi\deff0'.
    ...
    try { 
        ...
        $result = $api_instance->rtfWatermark($input_data);
...
<html>
  <body>
    <form action="rtf_watermark.php" method="post" enctype="multipart/form-data">
