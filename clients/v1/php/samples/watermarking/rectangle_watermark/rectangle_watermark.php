...
if($_FILES["file"]['size'] > 0)
{
    ...
    $input_data = new MuhimbiPDFOnline\Client\Model\RectangleWatermarkData();
    ...
    try { 
        ...
        $result = $api_instance->rectangleWatermark($input_data);
...
<html>
  <body>
    <form action="rectangle_watermark.php" method="post" enctype="multipart/form-data">
