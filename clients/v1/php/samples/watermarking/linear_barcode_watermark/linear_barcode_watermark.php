...
if($_FILES["file"]['size'] > 0)
{
    ...
    $input_data = new MuhimbiPDFOnline\Client\Model\LinearBarcodeWatermarkData();
    ...
    // ** Setup the type and content for the Linear Barcode
    $input_data->setContent('123456789012');
    $input_data->setBarcodeType($input_data::BARCODE_TYPE_UPC_A);
    ...
    $input_data->setWidth(300);                                             // ** The width of the watermark in pts (1/72nd of an inch). For example 144 is 2 inches wide.
    $input_data->setHeight(200);                                            // ** The height of the watermark.
    ...
    $input_data->setOpacity(100);                                            // ** A value between 0 (completely transparent) and 100 (fully visible)
    ...
    try { 
        ...
        $result = $api_instance->linearBarcodeWatermark($input_data);
...
<html>
  <body>
    <form action="linear_barcode_watermark.php" method="post" enctype="multipart/form-data">
