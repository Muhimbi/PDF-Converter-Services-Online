...
if($_FILES["file"]['size'] > 0)
{
    ...
    $input_data = new MuhimbiPDFOnline\Client\Model\ConvertPdfaData();
    ...
    $input_data->setPdfProfile($_POST["pdfProfile"]);
    ...
    try { 
        ...
        $result = $api_instance->convertPdfa($input_data);
...
<html>
  <body>
    <form action="sample.php" method="post" enctype="multipart/form-data">
      ...
      PDF profile: <select name="pdfProfile">
        <option value="Default">Default</option>
        <option value="PDF_A1B">PDF/A-1b</option>
        <option value="PDF_A2B">PDF/A-2b</option>
