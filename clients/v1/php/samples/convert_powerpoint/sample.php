...
if($_FILES["file"]['size'] > 0)
{
    ...
    $input_data = new MuhimbiPDFOnline\Client\Model\ConvertPowerpointData();
    ...
    try { 
        ...
        $result = $api_instance->convertPowerpoint($input_data);
...
<html>
  <body>
    <form action="sample.php" method="post" enctype="multipart/form-data">
      ...
      &nbsp;&nbsp;&nbsp;
      <input type="file" name="file" accept=".ppt,.pptx,.pptm,.xml,.odp,.otp,.pps,.ppsx,.ppsm"/>
