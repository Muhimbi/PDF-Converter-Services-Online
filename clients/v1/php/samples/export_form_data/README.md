# Sample - Export PDF Forms Data using PHP

The PHP sample provided in this section uses the [*Muhimbi PDF Converter Services Online*](https://github.com/Muhimbi/PDF-Converter-Services-Online) to export PDF Forms Data from a PDF document.
