# Sample - Convert file using asynchronous pattern in PHP

The PHP sample provided in this section uses the [*Muhimbi PDF Converter Services Online*](https://github.com/Muhimbi/PDF-Converter-Services-Online) to convert uploaded documents to PDF (or other formats). It is using the asynchronous pattern for long running operations (LRO).
