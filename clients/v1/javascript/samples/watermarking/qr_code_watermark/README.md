# Sample - Apply a QR Code watermark to a PDF or MS Office documents using JavaScript

The sample provided in this section uses the [*Muhimbi PDF Converter Services Online*](https://github.com/Muhimbi/PDF-Converter-Services-Online) to apply a QR Code, as a watermark, to a PDF or MS Office documents. 
