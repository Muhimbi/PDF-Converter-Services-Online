# Sample - Convert file to PDF using JavaScript & AngularJS

The sample provided in this section uses the [*Muhimbi PDF Converter Services Online*](https://github.com/Muhimbi/PDF-Converter-Services-Online) to convert a file to PDF (or other formats).
...
All other samples provided in this section use jQuery. If you prefer to use [AngularJS](https://angularjs.org/) then this example is the perfect starting point.
